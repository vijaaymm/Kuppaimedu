...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>/assets2/vendors/flag-icon-css/css/flag-icon.min.css">
    <link rel="stylesheet" href="<?php echo base_url();?>/assets2/vendors/css/vendor.bundle.base.css">
    <!-- Plugin css for this page -->
    <link rel="stylesheet" href="<?php echo base_url();?>/assets2/vendors/jquery-bar-rating/css-stars.css" />
    <link rel="stylesheet" href="<?php echo base_url();?>/assets2/vendors/font-awesome/css/font-awesome.min.css" />
    <!-- Layout styles -->
    <link rel="stylesheet" href="<?php echo base_url();?>/assets2/css/demo_2/style.css" />
    <!-- End layout styles -->
  ...
  <?php
        ...
        <nav class="navbar top-navbar col-lg-12 col-12 p-0">
          <div class="container">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
              <a class="navbar-brand brand-logo" href= "<?php echo base_url();?>Home/cust_dashboard">
                <img src="<?php echo base_url();?>/assets2/images/logo.png" alt="logo" />
              </a>
              <a class="navbar-brand brand-logo-mini" href= "<?php echo base_url();?>Home/cust_dashboard"><img src="<?php echo base_url();?>/assets2/images/logo-mini.png" alt="logo" /></a>
            </div>
                ...
                <li class="nav-item nav-profile dropdown">
                  <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="nav-profile-img">
                      <img src="<?php echo base_url();?>/assets2/images/faces/face1.jpg" alt="image" />
                    </div>
                    <div class="nav-profile-text">
                      <p class="text-black font-weight-semibold m-0"><?php echo $user_name; ?></p>
            ...
            <ul class="nav page-navigation">
              ...
              <li class="nav-item">
                <div class="nav-link d-flex">
                  ...
                  <a class="text-white" href="<?php echo base_url();?>/<?php echo base_url();?>/index.html"><i class="mdi mdi-home-circle"></i></a>
                </div>
              </li>
                    ...
                    <div class="table-responsive">
                      <table class="table custom-table text-dark">
                        ...
                        <tbody>
                          <tr>
                            <td>
                             <img src="<?php echo base_url();?>/assets2/images/faces/face2.jpg" class="me-2" alt="image" /> Jacob Jensen 
                            </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="<?php echo base_url();?>/assets2/images/faces/face3.jpg" class="me-2" alt="image" /> Cecelia Bradley 
                            </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="<?php echo base_url();?>/assets2/images/faces/face4.jpg" class="me-2" alt="image" /> Leah Sherman 
                            </td> 
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="<?php echo base_url();?>/assets2/images/faces/face5.jpg" class="me-2" alt="image" /> Ina Curry 
                            </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="<?php echo base_url();?>/assets2/images/faces/face7.jpg" class="me-2" alt="image" /> Lida Fitzgerald 
                            </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="<?php echo base_url();?>/assets2/images/faces/face2.jpg" class="me-2" alt="image" /> Stella Johnson 
                            </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="<?php echo base_url();?>/assets2/images/faces/face9.jpg" class="me-2" alt="image" /> Maria Ortiz 
                            </td>
                            <td>
                              <div class="d-flex">
                                <span class="pe-2 d-flex align-items-center">65%</span>
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-xl-4 stretch-card grid-margin">
                <div class="card color-card-wrapper">
                  <div class="card-body">
                    <img class="img-fluid card-top-img w-100" src="<?php echo base_url();?>/assets2/images/dashboard/img_5.jpg" alt="" />
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="<?php echo base_url();?>/assets2/vendors/js/vendor.bundle.base.js"></script>
    <!-- endinject -->
    <!-- Plugin js for this page -->
    <script src="<?php echo base_url();?>/assets2/vendors/jquery-bar-rating/jquery.barrating.min.js"></script>
    <script src="<?php echo base_url();?>/assets2/vendors/chart.js/Chart.min.js"></script>
    ...
    <script src="<?php echo base_url();?>/assets2/vendors/flot/jquery.flot.categories.js"></script>
    <script src="<?php echo base_url();?>/assets2/vendors/flot/jquery.flot.fillbetween.js"></script>
    <script src="<?php echo base_url();?>/assets2/vendors/flot/jquery.flot.stack.js"></script>
    <script src="<?php echo base_url();?>/assets2/js/jquery.cookie.js" type="text/javascript"></script>
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="<?php echo base_url();?>/assets2/js/off-canvas.js"></script>
    <script src="<?php echo base_url();?>/assets2/js/hoverable-collapse.js"></script>
    <script src="<?php echo base_url();?>/assets2/js/misc.js"></script>
    <script src="<?php echo base_url();?>/assets2/js/settings.js"></script>
    <script src="<?php echo base_url();?>/assets2/js/todolist.js"></script>
    <!-- endinject -->
