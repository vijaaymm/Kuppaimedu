            ...
            <ul class="nav page-navigation">
              ...
              <li class="nav-item">
                <a class="nav-link" href= "<?php echo base_url();?>Home/cust_book">
                  ...
                  <span class="menu-title">Booking Forms</span>
                </a>
              </li>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <tr>
                            <td class="py-1">
                              <img src="../assets2/images/faces-clipart/pic-1.png" alt="image" />
                            </td>
                            <td>Herman Beck</td>
                            <td>
                              <div class="progress">
                          ...
                          <tr>
                            <td class="py-1">
                              <img src="../assets2/images/faces-clipart/pic-2.png" alt="image" />
                            </td>
                            <td>Messsy Adam</td>
                            <td>
                              <div class="progress">
                          ...
                          <tr>
                            <td class="py-1">
                              <img src="../assets2/images/faces-clipart/pic-3.png" alt="image" />
                            </td>
                            <td>John Richards</td>
                            <td>
                              <div class="progress">
                          ...
                          <tr>
                            <td class="py-1">
                              <img src="../assets2/images/faces-clipart/pic-4.png" alt="image" />
                            </td>
                            <td>Peter Meggik</td>
                            <td>
                              <div class="progress">
